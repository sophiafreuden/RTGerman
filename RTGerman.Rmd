...
sums2 %>%
  group_by(ArtDate) %>% 
  summarise(Frequency = sum(zivilgesellschaft)) %>%
  ggplot(aes(x = ArtDate, y = Frequency)) +
  geom_point() +
  geom_smooth(method = 'loess') +
  labs(
    title = "Term Frequency Per Article Over Time",
    subtitle = "Term: 'zivilgesellschaft' (civil society), RT Search Term: 'clinton'",
    x = "Date",
    y = "Frequency"
  ...
  ggsave("clinton/zivilgesellschaft.png", width = 7)
```
