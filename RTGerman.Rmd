...
sums2 %>%
  group_by(ArtDate) %>% 
  summarise(Frequency = sum(demokratischepartei)) %>%
  ggplot(aes(x = ArtDate, y = Frequency)) +
  geom_point() +
  geom_smooth(method = 'loess') +
  labs(
    title = "Term Frequency Per Article Over Time",
    subtitle = "Term: 'demokratischepartei' (democraticparty), RT Search Term: 'soros'",
    x = "Date",
    y = "Frequency",
  ...
  ggsave("soros/demokratischepartei.png", width = 7)
```
