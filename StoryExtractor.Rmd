...
temp <- sums2 %>% select(c(ArtDate, soros))
view(temp)
print(data$URL[10]) # 17
print(data$URL[39]) # 14
print(data$URL[48]) # 13
print(data$URL[126]) # 12
print(data$URL[97]) # 11
print(data$URL[99]) # 11
print(data$URL[134]) # 11
print(data$URL[54]) # 10
print(data$URL[88]) # 10
print(data$URL[82]) # 9

# sum: 382; sample: 118 .3089
```
